<template>
    <div class="legal-container">
        <div class="content">
            ...
            <p>Bienvenido a Free Tarot Fun (freetarot.fun). Al acceder y utilizar nuestro servicio, aceptas cumplir y estar sujeto a los siguientes términos y condiciones de uso, que junto con nuestra <router-link to="/privacy">Política de Privacidad</router-link> y <router-link to="/cookies">Política de Cookies</router-link> gobiernan la relación de Free Tarot Fun contigo en relación a este sitio web.</p>
